...
.login-page {
  ...
  :deep(.el-input-group__append) {
    ...
    .el-button {
      ...
      &:hover {
        background: linear-gradient(135deg, lighten($neon-cyan, 10%), lighten($primary-color, 10%));
...
.login-container {
  ...
  &::before {
    ...
    right: 0;
    height: 1px;
    background: linear-gradient(90deg, transparent, rgba(0, 240, 255, 0.5), rgba(191, 90, 242, 0.5), transparent);
  }
